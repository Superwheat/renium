...
To pull or import into a separate folder, pass `-r DIR`; an empty folder gets its project file created. Create projects with `rbx init DIR`, never by writing `renium.project.jsonc` by hand.
