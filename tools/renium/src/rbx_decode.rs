...
use crate::bridge_server::{BridgeServer, ChunkFetchMetrics, DEFAULT_EXPORT_CHUNK_SIZE};
use crate::editor_sync::is_lua_source_class;
use crate::native_editor::rbx_variant_referent;
...
use crate::rbx_model::{BytecodeModelImportRefs, imported_instance_index};
...
pub(super) struct NativePropertyFilter {
    pub(super) allowed: HashSet<String>,
    pub(super) renamed: HashMap<String, String>,
    pub(super) output_names: HashSet<String>,
    pub(super) reconstruct_decal_color_map: bool,
    pub(super) reconstruct_weld_enabled: bool,
}
...
pub(super) fn rbx_reflection_class_is_a(
...
pub(super) fn native_property_filter(
    database: &ReflectionDatabase<'_>,
    class_name: &str,
...
pub(super) fn native_overlay_property_schemas(
    database: &ReflectionDatabase<'_>,
...
pub(super) fn overlay_property_names_value(
...
pub(super) fn conditional_ref_overlay_request(
...
pub(super) fn fetch_native_overlay_batches(
    bridge: &BridgeServer,
...
pub(super) fn merge_native_overlay_items(
...
pub(super) fn rbx_instance_to_settings_records(
...
pub(super) struct RbxSettingsConversionOptions<'a> {
    ...
    pub(super) native_properties_pre_filtered: bool,
    pub(super) native_filter: Option<&'a NativePropertyFilter>,
}

pub(super) fn rbx_properties_to_native_settings_records<'a>(
    class_name: &str,
...
pub(super) fn rbx_properties_to_settings_records<'a>(
    class_name: &str,
    property_entries: impl IntoIterator<Item = (&'a rbx_dom_weak::Ustr, &'a RbxVariant)>,
    database: &ReflectionDatabase<'_>,
    refs: &BytecodeModelImportRefs,
...
pub(super) fn rbx_variant_to_source_string(value: &RbxVariant) -> Option<String> {
    match value {
...
pub(super) fn rbx_variant_to_settings_json(
    value: &RbxVariant,
    descriptor: Option<&RbxPropertyDescriptor<'_>>,
    database: &ReflectionDatabase<'_>,
    refs: &BytecodeModelImportRefs,
...
pub(super) fn json_number_f64(value: f64) -> Value {
...
pub(super) fn nonfinite_float_from_json(value: &Value) -> Option<f64> {
...
pub(super) fn canonicalize_nonfinite_float_json(value: Value) -> Value {
