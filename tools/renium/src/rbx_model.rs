...
pub(super) fn rbx_dom_instance_by_path_unique(
    dom: &RbxWeakDom,
...
pub(super) fn rbx_dom_instance_path_parts(
    dom: &RbxWeakDom,
    referent: RbxRef,
...
pub(super) struct BytecodeModelExportRefs {
    ...
    pub(super) global_by_settings_id: Option<Arc<HashMap<String, RbxRef>>>,
    pub(super) by_path_key: HashMap<String, RbxRef>,
    pub(super) global_by_path_key: Option<Arc<HashMap<String, RbxRef>>>,
    pub(super) by_path_segments_key: HashMap<String, Option<RbxRef>>,
    pub(super) global_by_path_segments_key: Option<Arc<HashMap<String, Option<RbxRef>>>>,
}

pub(super) struct BytecodeExportPropertyMetadata<'db> {
    pub(super) property: Option<&'db RbxPropertyDescriptor<'db>>,
    pub(super) descriptor: Option<&'db RbxPropertyDescriptor<'db>>,
    pub(super) serialized_name: Option<&'static str>,
    pub(super) native_setter_property: bool,
    pub(super) skipped: bool,
}

pub(super) struct BytecodeExportClassMetadata<'db> {
    pub(super) triangle_mesh_part: bool,
    pub(super) model: bool,
    pub(super) decal: bool,
    pub(super) properties: HashMap<String, BytecodeExportPropertyMetadata<'db>>,
}
...
pub(super) struct BytecodeModelImportRefs {
    ...
    pub(super) settings_id_by_ref: HashMap<RbxRef, String>,
    pub(super) path_segments_by_index: Vec<Option<Vec<String>>>,
    pub(super) path_segments_by_ref: Arc<HashMap<RbxRef, Vec<String>>>,
    pub(super) path_ordinals_by_ref: Arc<HashMap<RbxRef, Vec<usize>>>,
}

pub(super) fn rbx_dom_path_import_refs(
    dom: &RbxWeakDom,
...
pub(super) fn canonicalize_settings_reference_documents(
...
pub(super) fn canonicalize_settings_reference_stores(src_root: &Path) -> Result<usize> {
...
pub(super) fn imported_instance_index(
...
pub(super) struct BytecodeModelImportOutcome {
    format: RbxModelFormat,
    pub(super) root_settings_ids: Vec<String>,
    pub(super) settings_ids: Vec<String>,
    pub(super) source_writes: Vec<Value>,
    source_files: BTreeMap<PathBuf, Vec<u8>>,
    pub(super) source_by_settings_id: BTreeMap<String, Vec<u8>>,
}

pub(super) struct RbxPlaceBuild {
    pub(super) dom: RbxWeakDom,
    pub(super) service_roots: Vec<(String, RbxRef)>,
    pub(super) documents_by_service: HashMap<String, SettingsBytecode>,
    pub(super) paths_by_service: HashMap<String, Vec<Option<EditorInstancePath>>>,
    pub(super) settings_writes: Vec<EditorSettingsWrite>,
    pub(super) total_instances: usize,
    pub(super) omitted_properties_by_class: HashMap<String, HashSet<String>>,
    pub(super) logical_properties_by_ref: HashMap<RbxRef, HashMap<rbx_dom_weak::Ustr, RbxVariant>>,
}
...
pub(super) fn import_rbx_model_into_document(
    document: &mut SettingsBytecode,
    settings_file: &Path,
    service: &str,
    model: &Path,
