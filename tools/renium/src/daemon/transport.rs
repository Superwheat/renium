...
pub(crate) const DEFAULT_DAEMON_CONTROL_PORT: u16 = 8780;
pub(crate) const MAX_DAEMON_LINE_BYTES: usize = 8 * 1024 * 1024;
pub(crate) const MAX_DAEMON_CONTROL_CONNECTIONS: usize = 16;
...
pub(crate) fn normalize_loopback_host(host: &str) -> Result<String> {
    let raw = host.trim();
...
pub(crate) fn is_loopback_endpoint(address: &SocketAddr) -> bool {
