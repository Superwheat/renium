...
use crate::editor::types::EditorInstancePath;
use crate::settings::bytecode::SettingsBytecode;
use crate::system::files::unique_child_stem;

pub(crate) fn assign_editor_instance_paths(
...
pub(crate) fn settings_children_by_parent(document: &SettingsBytecode) -> Vec<Vec<usize>> {
...
pub(crate) fn editor_service_root_index(
    document: &SettingsBytecode,
    service: &str,
) -> Option<usize> {
    document
...
pub(crate) fn editor_child_stems(
    document: &SettingsBytecode,
    child_indices: &[usize],
