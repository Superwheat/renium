...
pub(crate) struct PropertySchemaEntry {
...
pub(crate) const TYPE_ID_BOOL: u8 = 1;
pub(crate) const TYPE_ID_NUMBER: u8 = 2;
pub(crate) const TYPE_ID_STRING: u8 = 3;
pub(crate) const TYPE_ID_VECTOR2: u8 = 4;
pub(crate) const TYPE_ID_VECTOR3: u8 = 5;
pub(crate) const TYPE_ID_UDIM: u8 = 6;
pub(crate) const TYPE_ID_UDIM2: u8 = 7;
pub(crate) const TYPE_ID_COLOR3: u8 = 8;
pub(crate) const TYPE_ID_BRICK_COLOR: u8 = 9;
pub(crate) const TYPE_ID_ENUM_ITEM: u8 = 10;
pub(crate) const TYPE_ID_CFRAME: u8 = 11;
pub(crate) const TYPE_ID_RECT: u8 = 12;
pub(crate) const TYPE_ID_FONT: u8 = 13;
pub(crate) const TYPE_ID_COLOR_SEQUENCE: u8 = 14;
pub(crate) const TYPE_ID_NUMBER_SEQUENCE: u8 = 15;
pub(crate) const TYPE_ID_REF: u8 = 16;
pub(crate) const TYPE_ID_CONTENT_ID: u8 = 17;
pub(crate) const TYPE_ID_BINARY_STRING: u8 = 18;
pub(crate) const TYPE_ID_NUMBER_RANGE: u8 = 19;
pub(crate) const TYPE_ID_PHYSICAL_PROPERTIES: u8 = 20;
pub(crate) const TYPE_ID_AXES: u8 = 21;
pub(crate) const TYPE_ID_FACES: u8 = 22;
pub(crate) const TYPE_ID_RAY: u8 = 23;

pub(crate) const AXIS_NAMES: [(u8, &str); 3] = [(1, "X"), (2, "Y"), (4, "Z")];
pub(crate) const FACE_NAMES: [(u8, &str); 6] = [
    (1, "Right"),
    (2, "Top"),
    (4, "Back"),
    (8, "Left"),
...
pub(crate) fn load_rbx_dom_property_schema(
    project_root: &Path,
...
pub(crate) fn configure_bridge_property_candidates(
    bridge: &BridgeServer,
...
pub(crate) fn parse_property_schema_map(value: Option<&Value>) -> Result<PropertySchemaMap> {
...
pub(crate) fn parse_enum_value_name_map(value: Option<&Value>) -> Result<EnumValueNameMap> {
    let Some(value) = value else {
        return Ok(HashMap::new());
    };
