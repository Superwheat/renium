...
use super::editor_paths::build_editor_instance_paths;
...
use super::property_schema::{MESH_SIZE_TRANSPORT_PROPERTY, PropertySchemaMap};
...
pub(super) type EditorSiblingGroupCounts<'a> = HashMap<(usize, &'a str, &'a str), usize>;

pub(super) fn editor_sibling_group_counts(
...
pub(super) fn editor_instance_descriptor_from_path(
    document: &SettingsBytecode,
    index: usize,
...
pub(super) fn editor_instance_descriptor_for_known_path(
    document: &SettingsBytecode,
    index: usize,
    path_segments: Vec<String>,
    path_ordinals: Vec<usize>,
...
pub(super) fn push_editor_instance_change(
...
pub(super) fn append_editor_instance_reconcile(
    changes: &mut EditorChangeSet,
    document: &SettingsBytecode,
    service: &str,
) {
...
pub(super) fn append_editor_target_instance_upserts(
    changes: &mut EditorChangeSet,
    document: &SettingsBytecode,
    service: &str,
...
pub(super) fn append_editor_target_inline_source_changes(
    changes: &mut EditorChangeSet,
    document: &SettingsBytecode,
    service: &str,
    filter: &EditorPropertyFilter,
...
pub(super) fn append_editor_property_changes(
    changes: &mut EditorChangeSet,
    document: &SettingsBytecode,
    service: &str,
...
pub(super) fn append_native_editor_full_property_changes(
    changes: &mut EditorChangeSet,
    document: &SettingsBytecode,
    paths_by_index: &[Option<EditorInstancePath>],
    service: &str,
