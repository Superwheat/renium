...
The generated bundles aren't stored in Git. Build them from the repository root with:
...
CLI, extension, and plugin versions match, and writes the bundles and checksums
under `dist/`.
